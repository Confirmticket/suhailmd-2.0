...
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "2349139681581";
...
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "2349116343226";
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ Millian ® 』```", //*『sᴜʙsᴄʀɪʙᴇ • Mill Tech』*\ "),
 
  author : process.env.PACK_AUTHER|| "Millian",
  packname: process.env.PACK_NAME || "Sticker by",
  botname : process.env.BOT_NAME  || "MILLIAN-XMD",
